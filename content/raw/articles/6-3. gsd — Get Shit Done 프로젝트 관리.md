...
프로젝트의 주요 목표를 마일스톤으로 정의합니다. 질문을 통해 마일스톤의 범위와 성공 기준을 함께 도출합니다.
...
현재 페이즈의 상세 구현 계획을 작성합니다. 코드베이스를 분석하고 필요한 변경사항을 태스크 목록으로 만들어냅니다.
...
현재 페이즈의 접근 방식에 대해 논의합니다. 대안적 구현 방법, 트레이드오프 분석, 위험 요소 점검 등을 수행합니다.
