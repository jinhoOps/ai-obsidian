...
## [2026-05-20] refine | GEMINI.md 지식 거버넌스 3대 원칙 헌법 개정

- **작업 내용**:
    - **지식 거버넌스 명문화**: 고유 도메인이 특정 프레임워크나 AI 맥락에 맞춰 무리하게 축소·왜곡(아전인수식 해석)되지 않도록 통제하는 **'지식 거버넌스 3대 원칙'**을 운영 헌법인 `GEMINI.md`에 공식 추가함.
    - **통제 규칙**: 도메인 고유성 보존(Sovereignty), 수평적 대조 원칙(Parallel Mapping), 산업 표준 정의 준수(Industry Rigor)의 명문화로 향후 AI 에이전트의 지식 컴파일 및 인제스트 오남용에 강력한 가이드라인 구축.
- **잔여 문제**: 없음.
